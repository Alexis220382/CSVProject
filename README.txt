ОСОБЕННОСТИ ВЫПОЛНЕННОГО ПРИЛОЖЕНИЯ

1. Файл формата csv должен быть сохранен с условием (разделители запятые);



УСЛОВИЕ ТЕСТОВОГО ЗАДАНИЯ

Создать простое веб (или консольное) приложение, которое позволит импортировать в базу список контактов из CSV файла,
